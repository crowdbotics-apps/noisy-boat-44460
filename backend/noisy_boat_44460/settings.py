"""
Django settings for noisy_boat_44460 project.
...
ROOT_URLCONF = 'noisy_boat_44460.urls'
...
WSGI_APPLICATION = 'noisy_boat_44460.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_boat_44460 API",
    "DESCRIPTION": "API documentation for noisy_boat_44460 App",
    "VERSION": "v1",
}
